  ...
  return (
    <div className="space-y-5">
      ...
      <section className="rounded-xl border border-zinc-200 bg-white p-4">
        ...
        <p className="mt-3 border-t border-zinc-100 pt-3 text-[11px] leading-5 text-amber-800">Choose a theme to export theme-wise top teams. Top-ranked export uses the current live standings and does not change final decisions.</p>
      </section>
